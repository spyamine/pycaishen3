...
to put in site-packages/zipline/data/bundles/
...
def google_equities(symbols, start=None, end=None):
    ...
    def ingest(environ,
        ...
        # pd['ratio'] = None
        # pd['effective_date'] = None
        # pd['amount'] = None
        # pd['ex_date'] = None
        # pd['record_date'] = NaT
        # pd['declared_date'] = NaT
        # pd['pay_date'] = NaT
